...
public class ImageDialog extends JDialog implements WindowListener {
    ...
    void jbInit() throws Exception {
        ...
        header.setIcon(new ImageIcon(
                org.openmechanics.htmleditor.ImageDialog.class.getResource(
                    RESOURCE_FOLDER + "imgbig.png")));
        ...
        browseB.setIcon(new ImageIcon(
                org.openmechanics.htmleditor.ImageDialog.class.getResource(
                    RESOURCE_FOLDER + "fileopen16.png")));
    ...
    void browseB_actionPerformed(ActionEvent e) {
        ...
        chooser.addChoosableFileFilter(
                new org.openmechanics.htmleditor.filechooser.ImageFilter());
        chooser.setAccessory(
                new org.openmechanics.htmleditor.filechooser.ImagePreview(
                        chooser));
