        ...
        add(ClientList(MyListModel<ExtendedClient>().apply {
            resetData(listOf(
                    ...
                    ExtendedClient(Client.savedValidInstance().copy(firstName = "Rise", lastName = "Shine",
                            picture = MyImage.DEFAULT_PROFILE_WOMAN, category = ClientCategory.A), 1, null, null),
                    ExtendedClient(Client.savedValidInstance().copy(firstName = "Oxy", category = ClientCategory.C), 3, null, 0),
                    ...
                    ExtendedClient(Client.savedValidInstance().copy(firstName = "Rolf"), 10, DateTime.now().plusDays(3), 8),
                    ...
                    ExtendedClient(Client.savedValidInstance().copy(firstName = "Ur oft", birthday = DateTime.now().plusDays(1)), 39, null, 99),
                    ExtendedClient(Client.savedValidInstance().copy(firstName = "Long Ago"), 1, null, 390)
            ))
        }))
    })
}
