...
//    val pic = MyImage.DEFAULT_PROFILE_MAN // should NOT be used by report, as default pic not rendered
    val pic = MyImage.TEST_CLIENT_PIC1
    val report = ProtocolReportData(
            "Dr. Med Wurst",
            printDate = DateTime.now(),
            client = ClientReportData(
                    "Patient Wehleidig", children, job,
                    pic.toReportRepresentation()),
