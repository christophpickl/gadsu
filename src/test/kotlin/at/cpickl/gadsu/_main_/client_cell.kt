...
fun main(args: Array<String>) {
    Framed.show(JPanel().apply {
        ...
        val xclient3 = ExtendedClient(Client.savedValidInstance().copy(
                firstName = "Anna", lastName = "Nym", picture = MyImage.DEFAULT_PROFILE_ALIEN), 0, null,
                Treatment.savedValidInstance("1").copy(date = DateTime.now().clearSeconds().withMinuteOfHour(0).minusDays(12))
        )
